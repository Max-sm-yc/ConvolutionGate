...
### Findings
The largest bottleneck for the combined kernels is memory bandwidth (particularly for the 2 matmuls). Nsight Compute shows memory to be more heavily utilized than compute for all matmuls and the convolution gate. 

               Compute [%]   Memory [%]
     Matmul 1        48.71        73.84
...
Config: B=4, T=16, D=2048, K=4, dtype=float16

     pytorch_eager: mean=   0.269 ms  median=   0.267 ms  std= 0.006 ms  throughput= 3723.54 iter/s
       cuda_kernel: mean=   0.173 ms  median=   0.172 ms  std= 0.001 ms  throughput= 5793.28 iter/s
        cuda_graph: mean=   0.160 ms  median=   0.160 ms  std= 0.001 ms  throughput= 6241.13 iter/s
     torch.compile: mean=   0.175 ms  median=   0.174 ms  std= 0.003 ms  throughput= 5717.66 iter/s

Config: B=4, T=128, D=2048, K=4, dtype=float16

     pytorch_eager: mean=   0.464 ms  median=   0.464 ms  std= 0.004 ms  throughput= 2153.98 iter/s
       cuda_kernel: mean=   0.332 ms  median=   0.332 ms  std= 0.001 ms  throughput= 3011.68 iter/s
        cuda_graph: mean=   0.315 ms  median=   0.319 ms  std= 0.008 ms  throughput= 3173.20 iter/s
     torch.compile: mean=   0.448 ms  median=   0.445 ms  std= 0.009 ms  throughput= 2234.26 iter/s
...
*Nsight Compute profile shows the 2 CUTLASS kernels taking up 97% of runtime under setting B=8, T=2048, D=2048*
